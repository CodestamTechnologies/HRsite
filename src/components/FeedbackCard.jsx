export default function FeedbackCard(props) {
    return (
        <div className="bg-[#070127] bg-opacity-75 backdrop-filter backdrop-blur-md text-white text-left p-6 border-2 border-neutral-600 rounded-2xl flex flex-col gap-16 ">
            <p>"{props.review}"</p>
